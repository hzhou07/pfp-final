    ...
    where 
        ...
        updatePredSigma p1 s1 (v:vs) = updatePredSigma p1New s1New vs
            where
              ...
              updateForSingleParent :: [Int] ->  Map.Map Int [Int] -> Map.Map Int Int -> (Map.Map Int [Int], Map.Map Int Int) -- (findchild v)
...
accumulateCB :: Map.Map Int Double -> Int -> Map.Map Int Double -> Map.Map Int [Int] -> Map.Map Int Int -> [Int] ->  Map.Map Int Double  -- reverse call s
